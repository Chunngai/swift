...
/* Optional Chaining as an Alternative to Forces Unwrapping */
class Person {
...
/* Defining the Model Classes for Optional Chaining */
class Person {
  var residence: Residence?
}
...
if join.residence?.printNumberOfRooms() != nil {
  ...
  print("It was nit possible to print the number of rooms.")
}
