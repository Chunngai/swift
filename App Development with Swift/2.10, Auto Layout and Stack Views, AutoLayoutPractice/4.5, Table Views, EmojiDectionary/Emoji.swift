...
struct Emoji: Codable {
    ...
    Emoji(symbol: "😍", name: "Heart Eyes",
          description: "A smiley face with hearts for eyes. It typically conveys that you love something", usage: "love of something; attractive"),
    ...
    static func loadFromFile() -> [Emoji]? {
        ...
        if let retrievedEmojisData = try? Data(contentsOf: Emoji.ArchiveURL), let decodedEmojis = try? propertyListDecoder.decode([Emoji].self, from: retrievedEmojisData) {
