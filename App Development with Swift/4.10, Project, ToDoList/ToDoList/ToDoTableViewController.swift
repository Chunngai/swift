...
class ToDoTableViewController: UITableViewController, ToDoCellDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "ToDoCellIdentifier", for: indexPath) as? ToDoTableViewCell else { fatalError("Could not dequeue a cell") }
        cell.delegate = self
